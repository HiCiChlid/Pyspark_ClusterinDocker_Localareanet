...
## Steps:
 ...
 5. If one linux and one Windows:  
  ...
  7. Install spark and some other softwares as the master node through dockerfile `docker build -t your_image_name:master https://raw.githubusercontent.com/HiCiChlid/geosci-pyenv/main/dockerfile`.  
     Install the slave node through dockerfile `docker build -t your_image_name:slave https://raw.githubusercontent.com/HiCiChlid/Spark-cluster-in_docker-by_networkcable/main/dockerfile`, also you can use `docker build -t your_image_name:slave https://raw.githubusercontent.com/HiCiChlid/geosci-pyenv/main/dockerfile`;  
 ...
 16. Configure spark cluster  
  ...
  17. Configure Hadoop(Hdfs) cluster  
      ...
      17.12 Start Hdfs, `./sbin/start-dfs.sh` or `/usr/local/hadoop/sbin/start-dfs.sh` and input your password twice;  
